...
from gui_v2.models.observation_plan_table_model import ObservationPlanRecord, ObservationPlanTableModel
...
class ObservationPlanTable(QTableView):
    ...
    def __init__(self, parent=None):
        ...
        self.setObjectName("guiV2PlannerGeneratedPlanTable")
