"""Page-local setup log card for GUI-v2 setup and handoff messages."""
...
from gui_v2.helpers.logging_helpers import GUI_LOG_FORMATTER, QtPlainTextEditLogHandler, append_log_line
...
class LogConsoleCard(QFrame):
    ...
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        #     self,
        # )
        # body.setObjectName("guiV2CardBody")
        # body.setWordWrap(True)
        # grid.addWidget(body, 1, 0)

        self._console = QPlainTextEdit(self)
        self._console.setObjectName("guiV2LogConsole")
