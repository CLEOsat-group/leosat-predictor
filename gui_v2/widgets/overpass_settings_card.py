"""Overpass-specific settings card for GUI v2."""
...
class OverpassSettingsCard(QFrame):
    ...
    embed the legacy page-level time widget because GUI v2 already exposes the
    ...
    def __init__(
        ...
        *,
        ...
        self.start_date_edit.setObjectName("guiV2OverpassStartDateEdit")
        ...
        self.days_input.setObjectName("guiV2OverpassDaysInput")
