"""GUI-v2 column-mapping editor for Observation Planner preferences.

The widget is deliberately GUI-v2-local and depends only on the shared
...
class PlannerColumnMappingTable(QTableWidget):
    """Editable GUI-v2 table for donor-compatible planner column mappings.
    ...
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        self.setObjectName("guiV2PlannerColumnMappingTable")
    ...
    def populate(self, column_mapping: Mapping[str, Any] | None) -> None:
        ...
        for row, (logical, cfg) in enumerate(visible_items):
            ...
            width_spin.setObjectName(f"guiV2PlannerColumnWidth_{logical}")
