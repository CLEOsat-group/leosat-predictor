"""Header-level time-context widget for GUI v2."""
...
class TimeContextWidget(QFrame):
    """Live local/UTC/observatory-local time panel for the GUI v2 header.
    ...
    def __init__(self, parent: QWidget | None = None, *, interval_ms: int = 1000) -> None:
        ...
        self.setObjectName("guiV2TimeContext")
        self.setFrameShape(QFrame.Shape.StyledPanel)
        self._observatory_context: Mapping[str, Any] | None = None

        self._timer = QTimer(self)
        self._timer.setObjectName("guiV2TimeContextTimer")
    ...
    def _create_key_label(self, text: str) -> QLabel:
        ...
        label.setObjectName("guiV2TimeContextKey")
        return label

    def _create_value_label(self) -> QLabel:
        label = QLabel("—", self)
        label.setObjectName("guiV2TimeContextValue")
