"""TLE and satellite-selection card for GUI v2 overpass setup."""
...
from gui_v2.widgets.toggle_switch import ToggleSwitch

LogCallback = Callable[[str, str], None]


class TleServiceProtocol(Protocol):
    """Structural TLE-service protocol consumed by the GUI-v2 card."""
...
class TleSelectionCard(QFrame):
    ...
    def __init__(
        ...
        *,
        ...
        self.constellation_combo.setObjectName("guiV2TleConstellationCombo")
        ...
        self.apply_filter_button.setObjectName("guiV2TleApplyFilterButton")
        ...
        self.clear_filter_button.setObjectName("guiV2TleClearFilterButton")
        ...
        self.satellite_list.setObjectName("guiV2TleSatelliteList")
        ...
        self.select_all_checkbox.setObjectName("guiV2TleSelectAllCheck")
        self.select_all_checkbox.setEnabled(False)
        self.defaults_only_check = ToggleSwitch("Show Defaults Only", self)
        self.defaults_only_check.setObjectName("guiV2TleDefaultsOnlyCheck")

        self.selected_name_edit = QLineEdit(self)
        self.selected_name_edit.setObjectName("guiV2TleSelectedNameEdit")
        self.tle_line1_edit = QLineEdit(self)
        self.tle_line1_edit.setObjectName("guiV2TleLine1Edit")
        self.tle_line2_edit = QLineEdit(self)
        self.tle_line2_edit.setObjectName("guiV2TleLine2Edit")
        ...
        self.summary_label.setObjectName("guiV2CardBody")
