"""GUI-v2 Observation Planner setup and generation controls."""
...
from gui_v2.widgets.planner_load_button import PlannerLoadButton
...
class _PlannerControlsSection(QFrame):
    ...
    def __init__(self, title: str, parent: QWidget | None = None, *, field_columns: int = 1) -> None:
        ...
        self.setObjectName("guiV2PlannerControlsSection")
        ...
        title_label.setObjectName("guiV2CompactCardTitle")
...
class _PlannerButtonSection(QFrame):
    ...
    def __init__(self, title: str, parent: QWidget | None = None) -> None:
        ...
        self.button_grid.setObjectName("guiV2PlannerActionGrid")
...
class PlannerControlsCard(QFrame):
    ...
    def _build_binning_option_stack(self) -> None:
        ...
        self.binning_option_stack.setObjectName("guiV2PlannerBinningOptionStack")
