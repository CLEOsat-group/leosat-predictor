"""GUI-v2 presenter for exporting completed overpass results to CSV."""
...
from gui_v2.shell.mode_registry import MODE_OVERPASS
...
class OverpassExportPresenter:
    ...
    the actual CSV write policy to :class:`PredictionExportService` so GUI v2
