...
class NavigationNode:
    """Node in the GUI v2 navigation tree.
...
def build_navigation_tree() -> tuple[NavigationNode, ...]:
    ...
    tuple of NavigationNode
        Immutable navigation tree for the GUI v2 baseline.
    """
    return (
        NavigationNode(
            label="Predictions",
        ...
        NavigationNode(
            ...
            children=(
                NavigationNode(
                    page_id="configuration.general",
                    label="General",
                    title="General",
                    # subtitle="Observatory, TLE sources & satellites, interface, and paths & export.",
                    regions=(
                        "Observatory location",
                        "TLE sources & satellites",
                        "Interface",
                        "Paths & export",
                    ),
                ),
...
def build_navigation_domains(nodes: Sequence[NavigationNode]) -> tuple[NavigationDomain, ...]:
    ...
    return (
        ...
        NavigationDomain(
            ...
            default_page_id="configuration.general",
            page_ids=configuration_pages,
            tooltip="Configuration — general settings, prediction defaults, and planner defaults.",
            placement="bottom",
            icon_name="settings",
        ),
    )
