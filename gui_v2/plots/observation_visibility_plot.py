...
from gui_v2.models.observation_plan_table_model import GENERATED_SOURCE, MANUAL_SOURCE, ObservationPlanRecord
from gui_v2.styles import active_theme_palette
from gui_v2.workers.observation_planner_workers import PrepareVisibilityPlotWorker
    ...
    def _render_next_slice(self) -> None:
        ...
        try:
            while self._render_group_index < len(payload.groups):
                ...
                while self._render_group_offset < group.point_count:
                    ...
                    if self._render_group_offset < group.point_count and time.perf_counter() >= deadline:
                        self._render_timer.start(0)
                        return
