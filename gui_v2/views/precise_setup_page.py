"""Precise Prediction setup/run page for GUI v2."""
...
from gui_v2.services.location_service import LocationService
from gui_v2.services.prediction_export_service import PredictionExportService
from gui_v2.services.preferences_service import PreferencesService, PreferencesServiceError
from gui_v2.presenters.precise_export_presenter import PreciseExportPresenter
from gui_v2.shell.navigation_model import NavigationNode
from gui_v2.state.precise_execution_state import PreciseExecutionSnapshot, PreciseExecutionState
from gui_v2.state.precise_results_state import PLANNER_HANDOFF_DEFERRED_MESSAGE, PreciseResultsState
from gui_v2.state.precise_validation import (
    PreciseInputSnapshot,
    PreciseValidationState,
    validate_precise_inputs,
)
from gui_v2.widgets.location_card import LocationCard
from gui_v2.widgets.log_console_card import LogConsoleCard
from gui_v2.widgets.precise_settings_card import PreciseSettingsCard
from gui_v2.widgets.run_controls_card import RunControlsCard
from gui_v2.widgets.tle_selection_card import TleSelectionCard
...
class PreciseSetupPage(QWidget):
    """Production GUI-v2 page for precise setup, execution, and result actions.

    The page owns GUI-v2 precise setup cards, validates inputs, starts the
    ...
    concrete GUI-v2 planner consumer exists.
    """
    ...
    def __init__(
        ...
        *,
        ...
        self.setObjectName("guiV2PreciseSetupPage")
    ...
    def _handle_handoff_requested(self) -> None:
        """Send completed precise results to the GUI-v2 planner consumer."""
