"""GUI-v2 Observation Planner setup/generation page."""
...
from gui_v2.helpers.logging_helpers import append_log_line
from gui_v2.shell.navigation_model import NavigationNode
from gui_v2.state.planner_state import PlannerGenerationStatus, PlannerRuntimeSnapshot
from gui_v2.widgets.planner_controls import PlannerControlsCard
from gui_v2.widgets.planner_visibility_table import PlannerVisibilityTable



class PlannerShellCard(QFrame):
    """Styled planner card used by GUI-v2 planner pages."""
...
class PlannerPageShell(QWidget):
    """Base shell for concrete GUI-v2 planner pages."""
    ...
    def __init__(
        ...
        *,
        ...
        self.setObjectName("guiV2PlannerPageShell")
        ...
        self.status_label.setObjectName("guiV2WorkspaceStatusLine")
        self.status_label.setWordWrap(True)
        self.root_layout.addWidget(self.status_label)

        self.content_host = QWidget(self)
        self.content_host.setObjectName("guiV2WorkspaceGrid")
...
class PlannerSetupGenerationPage(PlannerPageShell):
    ...
    def __init__(
        ...
        *,
        ...
        splitter.setObjectName("guiV2PlannerSetupSplitter")
        ...
        self.visibility_table.setObjectName("guiV2PlannerVisibilityTable")
        ...
        self.log_console.setObjectName("guiV2PlannerLogConsole")
