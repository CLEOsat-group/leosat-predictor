"""Shared widgets and helpers for GUI-v2 configuration pages.
...
def create_integer_input(
    *,
    ...
    fields.  GUI v2 follows that pattern for configuration values that are
...
class ConfigurationCard(QFrame):
    """Styled card used by GUI-v2 configuration pages."""
...
class ConfigurationPageBase(QWidget):
    """Base class for concrete GUI-v2 configuration pages.
    ...
    def __init__(
        ...
        *,
        ...
        self.setObjectName("guiV2ConfigurationPage")
        ...
        content_host.setObjectName("guiV2WorkspaceGrid")
        ...
        if show_actions:
            ...
            self.save_button.setObjectName("guiV2ConfigurationSaveButton")
            ...
            self.revert_button.setObjectName("guiV2ConfigurationRevertButton")
    ...
    def load_from_service(self) -> None:
        ...
        self._set_status("Preferences loaded. Save changes to apply them to eligible GUI v2 pages.")
    ...
    def save(self) -> None:
        ...
        self._set_status(
            "Preferences saved. Applying eligible GUI v2 updates." + suffix,
            level="success",
        )
...
def create_read_only_value(text: str, parent: QWidget | None = None) -> QLabel:
    ...
    label.setObjectName("guiV2CardBody")
