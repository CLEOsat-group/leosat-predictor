"""Precise prediction results table and export page for GUI v2."""
...
class PreciseResultsPage(QWidget):
    ...
    def __init__(
        ...
        *,
        ...
        self.setObjectName("guiV2PreciseResultsPage")
    ...
    def refresh(self) -> None:
        ...
        if summary is None or dataframe is None or getattr(dataframe, "empty", True):
            if self._results_state.latest_error:
                ...
                self.status_label.setText("No precise results have been generated in GUI v2 yet.")
    ...
    def _build_summary_card(self) -> QFrame:
        ...
        self.export_button.setObjectName("guiV2ExportPreciseResultsButton")
        ...
        self.handoff_button.setObjectName("guiV2HandoffPreciseResultsButton")
        ...
        self.handoff_status_label.setObjectName("guiV2CardBody")
    ...
    def _build_workspace_tabs(self) -> QTabWidget:
        ...
        self.tabs.setObjectName("guiV2PreciseResultsTabs")
