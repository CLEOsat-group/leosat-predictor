"""GUI-v2 Observatory & Location configuration page."""
...
class ConfigurationObservatoryPage(ConfigurationPageBase):
    ...
    def __init__(
        ...
        *,
        ...
        self.name_edit.setObjectName("guiV2ConfigurationObservatoryNameEdit")
        set_compact_field_width(self.name_edit, width=MEDIUM_FIELD_WIDTH)
        self.latitude_edit = create_float_input(
            parent=card,
            object_name="guiV2ConfigurationObservatoryLatitudeEdit",
            minimum=-90.0,
            maximum=90.0,
            decimals=6,
        )
        self.longitude_edit = create_float_input(
            parent=card,
            object_name="guiV2ConfigurationObservatoryLongitudeEdit",
            minimum=-180.0,
            maximum=180.0,
            decimals=6,
        )
        self.altitude_edit = create_float_input(
            parent=card,
            object_name="guiV2ConfigurationObservatoryAltitudeEdit",
            minimum=0.0,
            maximum=100000.0,
            decimals=2,
        )
        ...
        self.map_button.setObjectName("guiV2ConfigurationSelectFromMapButton")
