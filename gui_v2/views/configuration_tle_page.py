...
class ConfigurationTlePage(ConfigurationPageBase):
    ...
    def __init__(
        ...
        *,
        ...
        self.tle_folder_edit.setObjectName("guiV2ConfigurationTleFolderEdit")
        ...
        self.expiration_edit = create_float_input(
            ...
            object_name="guiV2ConfigurationTleExpirationEdit",
            minimum=0.0001,
            maximum=100000.0,
            decimals=2,
            default=8.0,
        ...
        self.update_edit = create_float_input(
            parent=settings_card,
            object_name="guiV2ConfigurationTleUpdateEdit",
            minimum=0.0001,
            maximum=100000.0,
            decimals=2,
            default=8.0,
        ...
        self.allow_batch_check.setObjectName("guiV2ConfigurationTleAllowBatchCheck")
        ...
        self.sources_text.setObjectName("guiV2ConfigurationTleSourcesText")
