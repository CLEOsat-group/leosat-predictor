"""GUI-v2 prediction-default configuration page."""
...
class ConfigurationPredictionDefaultsPage(ConfigurationPageBase):
    ...
    def __init__(self, *, page: NavigationNode, preferences_service: PreferencesService, parent: QWidget | None = None) -> None:
        ...
        self.default_days_edit = create_integer_input(
            ...
            object_name="guiV2ConfigurationDefaultOverpassDaysEdit",
            minimum=1,
            maximum=365,
            default=2,
        )
        self.overpass_range_combo = QComboBox(overpass_card)
        self.overpass_range_combo.setObjectName("guiV2ConfigurationOverpassRangeCombo")
        ...
        self.default_interval_edit = create_integer_input(
            parent=precise_card,
            object_name="guiV2ConfigurationDefaultPreciseIntervalEdit",
            minimum=1,
            maximum=100000,
            default=1,
        )
        self.interval_unit_combo = QComboBox(precise_card)
        self.interval_unit_combo.setObjectName("guiV2ConfigurationDefaultIntervalUnitCombo")
        ...
        self.precise_range_combo.setObjectName("guiV2ConfigurationPreciseRangeCombo")
        ...
        self.visibility_margin_edit = create_float_input(
            ...
            object_name="guiV2ConfigurationVisibilityMarginEdit",
            minimum=0.0,
            maximum=100000.0,
            decimals=2,
            default=5.0,
        ...
        self.lowest_altitude_edit = create_float_input(
            parent=constraint_card,
            object_name="guiV2ConfigurationLowestAltitudeEdit",
            minimum=0.0,
            maximum=90.0,
            decimals=2,
            default=30.0,
        ...
        self.sun_high_edit = create_float_input(
            parent=constraint_card,
            object_name="guiV2ConfigurationSunZenithHighEdit",
            minimum=0.0,
            maximum=180.0,
            decimals=2,
            default=112.0,
        ...
        self.sun_low_edit = create_float_input(
            parent=constraint_card,
            object_name="guiV2ConfigurationSunZenithLowEdit",
            minimum=0.0,
            maximum=180.0,
            decimals=2,
            default=99.0,
