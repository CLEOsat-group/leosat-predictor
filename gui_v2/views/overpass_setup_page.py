"""Overpass Prediction setup/run static assembly page for GUI v2."""
...
from gui_v2.state.overpass_validation import (
...
from gui_v2.widgets.overpass_settings_card import OverpassSettingsCard
...
class OverpassSetupPage(QWidget):
    ...
    GUI-v2-native setup cards, wires services for preferences/location/TLE
    ...
    def __init__(
        ...
        *,
        ...
        self.setObjectName("guiV2OverpassSetupPage")
        ...
        scroll_area.setObjectName("guiV2OverpassSetupScrollArea")
        ...
        grid_host.setObjectName("guiV2OverpassSetupScrollContent")
