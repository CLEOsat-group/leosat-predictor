"""Qt-free preference state and validation objects for GUI v2.

The classes in this module are deliberately small value objects.  They are used
by the GUI-v2 preference service and future configuration pages to exchange
...
class PreferenceSnapshot:
    """Loaded preference state used by GUI-v2 configuration workflows.
...
class PreferenceSavePlan:
    ...
    plan where possible so GUI-v2 propagation can consume the same semantic
