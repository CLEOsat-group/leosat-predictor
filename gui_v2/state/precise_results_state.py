"""GUI-v2-local storage for the latest precise prediction results."""
...
PLANNER_HANDOFF_DEFERRED_MESSAGE = (
    "Send to Planner is visible but disabled until a GUI v2 planner consumer is implemented."
)
...
if TYPE_CHECKING:  # pragma: no cover - typing only
    ...
    from gui_v2.state.precise_execution_state import PreciseExecutionSnapshot
...
class PreciseResultsState:
    """Mutable GUI-v2 result cache for the latest precise run."""
    ...
    def can_handoff(self, *, consumer_available: bool = False) -> bool:
        """Return whether precise results can be sent to a real GUI-v2 planner consumer.
