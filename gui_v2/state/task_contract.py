"""Qt-free task-reporting contract for future GUI v2 workflows.

This module defines the vocabulary and value objects that future GUI v2
...
from gui_v2.state.status_event import StatusEvent, StatusLevel


class TaskKind(StrEnum):
    """Stable identifiers for future GUI v2 operation families."""
...
class TaskState(StrEnum):
    """Lifecycle states for future long-running GUI v2 tasks."""
...
def status_event_from_task_event(event: TaskEvent) -> StatusEvent:
    ...
    return StatusEvent(level=level, message=message, detail=detail, source="gui_v2.task_contract")
