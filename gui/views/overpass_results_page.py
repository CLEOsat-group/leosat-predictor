"""Overpass results table workspace for GUI Task 44D."""
...
class OverpassResultsPage(QWidget):
    ...
    def __init__(
        ...
        *,
        ...
        self.setObjectName("guiOverpassResultsPage")
    ...
    def refresh(self) -> None:
        ...
        if summary is None or dataframe is None or getattr(dataframe, "empty", True):
            if self._results_state.latest_error:
                ...
                self.status_label.setText("No overpass results have been generated in GUI yet.")
    ...
    def _build_summary_card(self) -> QFrame:
        ...
        self.export_button.setObjectName("guiExportOverpassResultsButton")
    ...
    def _build_workspace_tabs(self) -> QTabWidget:
        ...
        self.tabs.setObjectName("guiOverpassResultsTabs")
