"""GUI Observation Planner results workspace page.
...
from gui.presenters import PlannerExportPresenter
from gui.shell.navigation_model import NavigationNode
from gui.state.planner_state import PlannerRuntimeSnapshot
from gui.views.planner_setup_generation_page import PlannerPageShell
from gui.widgets.planner_results_workspace import PlannerResultsWorkspace


class PlannerResultsPage(PlannerPageShell):
    """Concrete 2x2 results workspace for the GUI Observation Planner."""
    ...
    def _handle_plot_data_changed(self, dataframe: object, color_map: object | None = None) -> None:
        ...
        The GUI shell constructs all pages up front.  Rendering the planner
    ...
    def _export_plan(self) -> None:
        """Export the current observation plan through the GUI presenter."""
