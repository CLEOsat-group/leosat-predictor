"""Editable GUI Observation Planner preference page."""
...
class ConfigurationPlannerPreferencesPage(ConfigurationPageBase):
    ...
    def _build_tabbed_editor(self) -> None:
        ...
        self.tabs.setObjectName("guiPlannerPreferencesTabs")
        ...
        general_tab, general_grid = self._create_scroll_tab("guiPlannerPreferencesGeneralTab")
        self._build_general_tab(general_grid)
        self.tabs.addTab(general_tab, "General")

        diagnostics_tab, diagnostics_grid = self._create_scroll_tab("guiPlannerPreferencesDiagnosticsTab")
        self._build_diagnostics_tab(diagnostics_grid)
        self.tabs.addTab(diagnostics_tab, "Diagnostics")

        columns_tab, columns_grid = self._create_scroll_tab("guiPlannerPreferencesColumnsTab")
    ...
    def _add_field(grid: QGridLayout, row: int, label: str, widget: QWidget) -> None:
        ...
        label_widget.setObjectName("guiFieldLabel")
    ...
    def _attach_field_grid(card: ConfigurationCard, field_grid: QGridLayout) -> None:
        ...
        field_host.setObjectName("guiPlannerPreferenceFieldHost")
    ...
    def _build_general_tab(self, grid: QGridLayout) -> None:
        ...
        self.filename_pattern_edit.setObjectName("guiPlannerPreference_filename_pattern")
        ...
        self.legend_page_size_edit = create_integer_input(
            parent=output_card,
            object_name="guiPlannerPreference_legend_page_size",
            minimum=1,
            maximum=50,
            default=5,
        ...
        self.coordinate_format_combo.setObjectName("guiPlannerPreference_default_coordinate_format")
        ...
        self.exposure_time_edit = create_float_input(
            parent=timing_card,
            object_name="guiPlannerPreference_exposure_time_sec",
            minimum=0.1,
            maximum=3600.0,
            decimals=2,
            default=5.0,
        ...
        self.time_range_edit = create_float_input(
            parent=timing_card,
            object_name="guiPlannerPreference_time_range_sec",
            minimum=0.0,
            maximum=3600.0,
            decimals=2,
            default=0.0,
        ...
        self.min_elevation_edit = create_float_input(
            parent=timing_card,
            object_name="guiPlannerPreference_min_elevation_deg",
            minimum=-90.0,
            maximum=90.0,
            decimals=2,
            default=0.0,
        ...
        self.tolerance_edit = create_float_input(
            parent=timing_card,
            object_name="guiPlannerPreference_tolerance_sec",
            minimum=0.0,
            maximum=3600.0,
            decimals=2,
            default=1.0,
        ...
        self.spacing_edit = create_float_input(
            parent=timing_card,
            object_name="guiPlannerPreference_spacing_min",
            minimum=0.1,
            maximum=60.0,
            decimals=2,
            default=3.0,
        ...
        self.default_mode_combo.setObjectName("guiPlannerPreference_default_mode")
        ...
        self.plan_method_combo.setObjectName("guiPlannerPreference_default_plan_method")
        ...
        self.binning_mode_combo.setObjectName("guiPlannerPreference_default_binning_mode")
        ...
        self.sample_bins_label.setObjectName("guiFieldLabel")
        self.bin_width_label = QLabel("Default bin width [deg]")
        self.bin_width_label.setObjectName("guiFieldLabel")
        self.custom_elevation_edges_label = QLabel("Elevation bin edges")
        self.custom_elevation_edges_label.setObjectName("guiFieldLabel")
        self.custom_solar_phase_edges_label = QLabel("Solar phase bin edges")
        self.custom_solar_phase_edges_label.setObjectName("guiFieldLabel")
        self.sample_bins_edit = create_integer_input(
            parent=sampling_card,
            object_name="guiPlannerPreference_default_sample_bins",
            minimum=1,
            maximum=50,
            default=6,
            width=_PLANNER_NUMERIC_FIELD_WIDTH,
        ...
        self.bin_width_edit = create_float_input(
            parent=sampling_card,
            object_name="guiPlannerPreference_default_bin_width_deg",
        ...
        self.random_seed_edit = create_integer_input(
            parent=sampling_card,
            object_name="guiPlannerPreference_random_seed",
            minimum=0,
            maximum=2147483647,
            default=12345,
            width=112,
        ...
        self.custom_elevation_edges_edit.setObjectName("guiPlannerPreference_custom_elevation_bin_edges")
        ...
        self.custom_solar_phase_edges_edit.setObjectName("guiPlannerPreference_custom_solar_phase_bin_edges")
    ...
    def _build_optimization_repair_cards(self, grid: QGridLayout, *, row: int) -> None:
        ...
        self.optimization_enabled_check.setObjectName("guiPlannerPreference_optimization_enabled")
        self.optimization_trials_edit = create_integer_input(
            parent=optimizer_card,
            object_name="guiPlannerPreference_optimization_trials",
            minimum=1,
        ...
        self.candidate_depth_edit = create_integer_input(
            parent=optimizer_card,
            object_name="guiPlannerPreference_candidate_depth",
            minimum=1,
        ...
        self.optimization_objective_combo.setObjectName("guiPlannerPreference_optimization_objective")
        ...
        self.local_repair_enabled_check.setObjectName("guiPlannerPreference_local_repair_enabled")
        self.local_repair_max_additions_edit = create_integer_input(
            parent=repair_card,
            object_name="guiPlannerPreference_local_repair_max_additions",
            minimum=0,
        ...
        self.local_repair_candidate_limit_edit = create_integer_input(
            parent=repair_card,
            object_name="guiPlannerPreference_local_repair_candidate_limit",
            minimum=0,
        ...
        self.local_repair_attempt_limit_edit = create_integer_input(
            parent=repair_card,
            object_name="guiPlannerPreference_local_repair_attempt_limit",
            minimum=0,
    ...
    def _build_diagnostics_tab(self, grid: QGridLayout) -> None:
        ...
        self.transition_constraint_mode_combo.setObjectName("guiPlannerPreference_transition_constraint_mode")
        ...
        self.transition_safety_margin_edit = create_float_input(
            ...
            object_name="guiPlannerPreference_transition_safety_margin_sec",
            minimum=0.0,
        ...
        self.slew_diagnostics_enabled_check.setObjectName("guiPlannerPreference_slew_diagnostics_enabled")
        ...
        self.slew_az_rate_edit = create_float_input(
            parent=motion_card,
            object_name="guiPlannerPreference_slew_az_rate_deg_per_sec",
        ...
        self.slew_alt_rate_edit = create_float_input(
            parent=motion_card,
            object_name="guiPlannerPreference_slew_alt_rate_deg_per_sec",
            minimum=MIN_SLEW_RATE_DEG_PER_SEC,
            maximum=MAX_SLEW_RATE_DEG_PER_SEC,
            decimals=2,
            default=1.0,
        ...
        self.slew_settle_time_edit = create_float_input(
            parent=motion_card,
            object_name="guiPlannerPreference_slew_settle_time_sec",
            minimum=0.0,
        ...
        self.slew_acquisition_time_edit = create_float_input(
            parent=motion_card,
            object_name="guiPlannerPreference_slew_acquisition_time_sec",
            minimum=0.0,
            maximum=MAX_SLEW_OVERHEAD_SEC,
            decimals=1,
            default=10.0,
        ...
        self.slew_exposure_time_edit = create_float_input(
            parent=motion_card,
            object_name="guiPlannerPreference_slew_exposure_time_sec",
            minimum=0.0,
            maximum=MAX_SLEW_OVERHEAD_SEC,
            decimals=1,
            default=50.0,
        ...
        self.slew_transition_sample_limit_edit = create_integer_input(
            parent=motion_card,
            object_name="guiPlannerPreference_slew_transition_sample_limit",
