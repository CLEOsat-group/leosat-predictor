"""GUI Observation Planner diagnostics page."""
...
from gui.widgets.planner_diagnostics_workspace import PlannerDiagnosticsWorkspace


class PlannerDiagnosticsPage(PlannerPageShell):
    """Diagnostics page for GUI Observation Planner parity."""
