"""Qt-free runtime state for the GUI Observation Planner port.
...
class PlannerGenerationStatus(Enum):
    """Lifecycle states for the GUI planner workflow."""
...
class PlannerDataReadiness:
    ...
    def ready_for_generation(self) -> bool:
        ...
        GUI preserves GUI-v1 Observation Planner parity: plan generation
...
class PlannerRuntimeSnapshot:
    """Immutable snapshot of GUI planner runtime metadata."""
...
class PlannerRuntimeState:
    """Mutable GUI planner state holder.
