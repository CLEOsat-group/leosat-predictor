"""GUI-local storage for the latest overpass prediction results."""
...
if TYPE_CHECKING:  # pragma: no cover - typing only
    ...
    from gui.state.overpass_execution_state import OverpassExecutionSnapshot
...
class OverpassResultsState:
    """Mutable GUI result cache for the latest overpass run."""
