"""State/value objects for GUI."""

from __future__ import annotations

from gui.state.activity_state import ActivityEntry, ActivityState
from gui.state.status_event import DEFAULT_READY_EVENT, StatusEvent, StatusLevel
from gui.state.time_context import TimeContextSnapshot, create_time_context_snapshot
from gui.state.task_contract import (
    CancellationRequest,
    TaskErrorSummary,
    TaskEvent,
    TaskKind,
...
from gui.state.overpass_results_state import (
    OverpassResultSummary,
    OverpassResultsState,
    summarize_overpass_results,
)

from gui.state.precise_execution_state import (
    PreciseExecutionSnapshot,
    PreciseExecutionState,
    PreciseRunStatus,
)
from gui.state.precise_results_state import (
    PreciseResultSummary,
    PreciseResultsState,
    summarize_precise_results,
)
...
from gui.state.preferences_state import (
    PreferenceSavePlan,
    PreferenceSnapshot,
    PreferenceValidationIssue,
    PreferenceValidationResult,
