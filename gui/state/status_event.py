"""Qt-free status/event state model for GUI.
...
class StatusEvent:
    """Display-ready status/event message for the GUI global status surface.
    ...
    source : str, optional
        Non-visual source identifier.  Defaults to ``"gui"``.
    ...
    @classmethod
    def ready(cls, message: str, *, detail: str = "", source: str = "gui") -> "StatusEvent":
    ...
    @classmethod
    def error(cls, message: str, *, detail: str = "", source: str = "gui") -> "StatusEvent":
        """Create an error status event."""
        return cls(level=StatusLevel.ERROR, message=message, detail=detail, source=source)

    @classmethod
    def busy(cls, message: str, *, detail: str = "", source: str = "gui") -> "StatusEvent":
