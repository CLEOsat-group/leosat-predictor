"""GUI-native dialog for selecting an observer location from a map.

The dialog owns only GUI map presentation and selection flow.  It reuses the
...
class LocationMapDialog(QDialog):
    ...
    def __init__(self, parent: QWidget | None = None, *, show_set_default: bool = False) -> None:
        ...
        self.setObjectName("guiLocationMapDialog")
        ...
        self.map_view.setObjectName("guiLocationMapView")
        ...
        self.apply_button.setObjectName("guiLocationMapApplyButton")
        ...
        self.set_default_button.setObjectName("guiLocationMapSetDefaultButton")
        ...
        self.close_button.setObjectName("guiLocationMapCloseButton")
    ...
    def _on_map_load_finished(self, ok: bool) -> None:
        ...
        if ok:
            ...
            logger.info("GUI location map WebEngine page loaded successfully.")
        else:
            self.status_label.setText(
                "Map page failed to load. Manual location entry remains available in the setup page."
            )
            logger.error("GUI location map WebEngine page failed to load.")
    ...
    def _on_map_ready(self) -> None:
        ...
        logger.info("GUI location map bridge reported ready.")
