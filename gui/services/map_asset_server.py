"""Local HTTP asset server for GUI map-selection assets.

The GUI location-map dialog serves its HTML, JavaScript, and CSS from a
...
class MapAssetRequestHandler(SimpleHTTPRequestHandler):
    """Serve GUI map assets with a browser-friendly referrer policy."""
...
class LocalMapAssetServer:
    ...
    assets_dir : str or pathlib.Path, optional
        ...
        omitted, the package-local ``gui/map_assets`` directory is served.
