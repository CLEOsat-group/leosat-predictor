"""GUI-owned preference persistence and validation service.

This module is the non-visual boundary between GUI configuration pages and
...
class PreferencesService:
    """Load, validate, merge, and save GUI preferences.
    ...
    def load(self) -> dict[str, Any]:
        """Load merged, normalized preferences for existing GUI callers.
    ...
    def save_and_prepare_application(
        ...
        *,
        ...
        used by current GUI code while returning the GUI save-plan type.
        """
    ...
    def _merge_observation_planner_for_save(
        ...
        GUI now exposes the planner diagnostics and motion-model keys in the
    ...
    def _build_save_plan(
        ...
        """Build a structured save plan for future GUI propagation."""
