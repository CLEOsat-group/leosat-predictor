"""Professional dashboard shell for GUI."""
...
from gui.shell.navigation_model import NavigationNode, breadcrumb_for_page
from gui.shell.navigation_sidebar import NavigationSidebar
from gui.state import ActivityState, StatusEvent, StatusLevel
from gui.styles.icon_provider import set_themed_icon
from gui.widgets import HeaderStatusWidget, LoadingOverlay, TimeContextWidget

_logger = logging.getLogger(__name__)


class DashboardShell(QWidget):
    """Navigation and stacked workspace container for GUI."""

    def __init__(self, nodes: tuple[NavigationNode, ...], parent: QWidget | None = None) -> None:
        super().__init__(parent)
        self.setObjectName("guiShell")
        self._nodes = nodes
        ...
        self._header_context.setObjectName("guiContextLabel")
        self._navigation_toggle = QPushButton("", self)
        self._navigation_toggle.setObjectName("guiNavigationToggle")
        ...
        self._splitter.setObjectName("guiMainSplitter")
        ...
        workspace_frame.setObjectName("guiWorkspace")
        ...
        self._stack.setObjectName("guiWorkspaceStack")
    ...
    def _build_header(self) -> QFrame:
        ...
        header = QFrame(self)
        header.setObjectName("guiHeader")
        ...
        title_area.setObjectName("guiHeaderTitleArea")
        ...
        title_text.setObjectName("guiHeaderTitleText")
        ...
        title.setObjectName("guiProductTitle")
        title.setSizePolicy(
            QSizePolicy.Policy.Expanding,
            QSizePolicy.Policy.Fixed,
        )
        ...
        status_area.setObjectName("guiHeaderStatusArea")
        ...
        time_area.setObjectName("guiHeaderTimeArea")
