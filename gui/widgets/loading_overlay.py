...
class LoadingSpinner(QWidget):
    ...
    def __init__(self, parent: QWidget | None = None, *, logical_size: int = 34) -> None:
        ...
        self.setObjectName("guiLoadingSpinner")
...
class LoadingOverlay(QWidget):
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(parent)
        self.setObjectName("guiLoadingOverlay")
        self.setAttribute(Qt.WidgetAttribute.WA_TransparentForMouseEvents, True)
        ...
        self.panel.setObjectName("guiLoadingPanel")
        ...
        self.message_label.setObjectName("guiLoadingMessage")
