"""Location and observatory-context card for GUI overpass setup."""
...
from gui.services.location_service import LocationRecord, LocationService, LocationValidationError
from gui.services.preferences_service import PreferencesService
...
class LocationCard(QFrame):
    ...
    def __init__(
        ...
        *,
        ...
        self.set_default_button.setObjectName("guiLocationSetDefaultButton")
        self.set_default_button.setProperty("buttonRole", "success")
        self.clear_button = QPushButton("Clear", self)
        self.clear_button.setObjectName("guiLocationClearButton")
    ...
    def _select_from_map(self) -> None:
        """Open the GUI-native map dialog and apply a selected location."""
        try:
