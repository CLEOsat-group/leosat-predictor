"""GUI Observation Planner results workspace adapters.

This module owns the GUI results workspace composition.  It still reuses
small donor widgets where they remain appropriate, but Observation Info is now
implemented as a native GUI card so it can present the selected observation,
...
from gui.plots.observation_visibility_plot import ObservationVisibilityPlot
from gui.widgets.observation_plan_actions import ObservationPlanActions
from gui.widgets.observation_plan_table import ObservationPlanTable
...
class PlannerResultCard(QFrame):
    """Styled GUI result card with an optional title and body."""
...
class PlannerPlotWorkspace(PlannerResultCard):
    """Top-row planner plot workspace backed by the real visibility plot."""
    ...
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        self.setObjectName("guiPlannerPlotWorkspace")
        self.setMinimumHeight(210)
        self.setMaximumHeight(320)

        self.visibility_plot = V2PlannerVisibilityPlot(self)
        self.visibility_plot.setObjectName("guiPlannerVisibilityPlot")
        self.visibility_plot.setMinimumHeight(160)
        self.layout.addWidget(self.visibility_plot, 1)
...
class PlannerObservationInfoWorkspace(PlannerResultCard):
    """GUI Observation Info card with copy controls and start time."""
    ...
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        self.setObjectName("guiPlannerObservationInfoWorkspace")
    ...
    def _build_content(self) -> None:
        ...
        details_frame.setObjectName("guiObservationDetailsFrame")
        ...
        # details_title.setObjectName("guiObservationInfoSectionTitle")
        ...
        copy_widget.setObjectName("guiObservationCopyBlock")
        ...
        exposure_widget.setObjectName("guiObservationExposureBlock")
        ...
        exposure_label.setObjectName("guiObservationInfoName")
        self.exposure_time_edit = QLineEdit(exposure_widget)
        self.exposure_time_edit.setObjectName("guiObservationExposureInput")
        ...
        start_block.setObjectName("guiObservationStartBlock")
        ...
        start_label.setObjectName("guiObservationStartLabel")
        ...
        action_widget.setObjectName("guiObservationActionBlock")
    ...
    def _detail_value_label(self) -> QLabel:
        ...
        label = QLabel("", self)
        label.setObjectName("guiObservationInfoValue")
    ...
    def _add_detail_row(self, layout: QGridLayout, row: int, label_text: str, value_label: QLabel) -> None:
        ...
        label.setObjectName("guiObservationInfoName")
...
class PlannerGeneratedPlanWorkspace(PlannerResultCard):
    ...
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        self.setObjectName("guiPlannerGeneratedPlanWorkspace")
        self.setMinimumHeight(240)

        self.plan_table = ObservationPlanTable(self)
        self.plan_table.setObjectName("guiPlannerGeneratedPlanTable")
        self.plan_table.setMinimumHeight(180)
        self.layout.addWidget(self.plan_table, 1)

        self.actions = ObservationPlanActions(self)
        self.actions.setObjectName("guiPlannerGeneratedPlanActions")
...
class PlannerResultsWorkspace(QWidget):
    """Concrete GUI 2x2 planner results workspace."""
    ...
    def __init__(self, parent: QWidget | None = None) -> None:
        super().__init__(parent)
        self.setObjectName("guiPlannerResultsWorkspace")
