"""Header-integrated global status surface for GUI."""
...
from gui.state import DEFAULT_READY_EVENT, StatusEvent


class HeaderStatusWidget(QFrame):
    """Compact global status surface for the GUI header.

    The widget renders the Qt-free :class:`~gui.state.StatusEvent` model as a
    ...
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        self.setObjectName("guiHeaderStatusWidget")
        ...
        self._level_label.setObjectName("guiHeaderStatusLevel")
        ...
        self._message_label.setObjectName("guiHeaderStatusMessage")
