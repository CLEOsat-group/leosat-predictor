"""GUI Observation Planner diagnostics workspace.

The widgets in this module port the GUI-v1 planner diagnostics behavior into
small GUI adapters.  They render only backend-provided diagnostics objects;
...
from gui.styles import repolish, active_theme_name, active_theme_palette
from gui.presenters.planner_diagnostics_presenter import (
    DiagnosticsCardPresentation,
    present_planner_diagnostics_overview,
)
from gui.state.planner_state import PlannerRuntimeSnapshot
...
class DiagnosticsInfoCard(QFrame):
    """Small GUI diagnostics card used in overview and details tabs."""

    def __init__(self, title: str, parent: QWidget | None = None) -> None:
        super().__init__(parent)
        self.setObjectName("guiDiagnosticsCard")
        ...
        self.title_label.setObjectName("guiDiagnosticsCardTitle")
        self.title_label.setWordWrap(True)
        layout.addWidget(self.title_label)

        self.body_label = QLabel("—", self)
        self.body_label.setObjectName("guiDiagnosticsCardBody")
...
class V2PlannerDiagnosticsPlots(QWidget):
    ...
    def __init__(self, parent: QWidget | None = None) -> None:
        super().__init__(parent)
        self.setObjectName("guiPlannerDiagnosticsPlots")
        ...
        self.plot_tabs.setObjectName("guiPlannerDiagnosticsPlotTabs")
    ...
    def _create_plot_page(self, key: str, title: str, description: str) -> QWidget:
        ...
        page = QWidget(self)
        page.setObjectName("guiPlannerDiagnosticsPlotPage")
        ...
        label.setObjectName("guiDiagnosticsPlotDescription")
        label.setWordWrap(True)
        graphics = pg.GraphicsLayoutWidget(page)
        graphics.setObjectName(f"guiDiagnosticsGraphics_{key}")
    ...
    def changeEvent(self, event) -> None:  # noqa: N802 - Qt API.
        """Refresh pyqtgraph styling after live GUI theme changes."""
    ...
    def _refresh_plot_theme(self) -> None:
        """Repaint diagnostic plots with the active GUI theme."""
    ...
    def _prepare_plot(self, plot):
        """Apply the active GUI plot theme to one pyqtgraph plot."""
    ...
    def _set_plot_label(self, plot, axis: str, text: str) -> None:
        """Set one axis label using the active GUI plot text color."""
    ...
    def _apply_background(self, graphics: pg.GraphicsLayoutWidget | None = None) -> None:
        """Apply active GUI background to one or all graphics layouts."""
    ...
    def _plot_theme(self) -> dict[str, object]:
        """Return plot colors from the active semantic GUI palette."""
    ...
    def _uses_dark_theme() -> bool:
        """Return whether the active semantic GUI palette is dark."""
        return active_theme_name() == "dark"



class PlannerDiagnosticsWorkspace(QWidget):
    """Tabbed GUI workspace for planner diagnostics."""
    ...
    def __init__(self, parent: QWidget | None = None) -> None:
        super().__init__(parent)
        self.setObjectName("guiPlannerDiagnosticsWorkspace")
        self._diagnostics: object | None = None
        ...
        self.summary_strip.setObjectName("guiDiagnosticsSummaryStrip")
        ...
        self.tabs.setObjectName("guiPlannerDiagnosticsTabs")
    ...
    def _build_overview_tab(self) -> QWidget:
        ...
        content.setObjectName("guiPlannerDiagnosticsOverview")
    ...
    def _build_table_tab(self) -> QWidget:
        ...
        self.table_title.setObjectName("guiDiagnosticsTableTitle")
        self.table_title.setWordWrap(True)
        self.table_model = DiagnosticsTableModel(tab)
        self.table_view = QTableView(tab)
        self.table_view.setObjectName("guiPlannerDiagnosticsTable")
    ...
    def _build_details_tab(self) -> QWidget:
        ...
        content = QWidget(self)
        content.setObjectName("guiPlannerDiagnosticsDetailsContent")
        grid = QGridLayout(content)
        grid.setContentsMargins(12, 12, 12, 12)
        grid.setHorizontalSpacing(12)
        grid.setVerticalSpacing(12)
        self.details_text = QPlainTextEdit(content)
        self.details_text.setObjectName("guiPlannerDiagnosticsDetailsText")
    ...
    def _wrap_scroll_area(self, content: QWidget) -> QScrollArea:
        ...
        scroll.setObjectName("guiPlannerDiagnosticsScrollArea")
