"""Theme-aware SVG icon loading for GUI.

Only repository-owned, licensed assets under :mod:`gui.assets.icons` are
...
from gui.styles.theme_tokens import ThemePalette, palette_for
...
_THEME_PROPERTY = "guiTheme"
_ICON_NAME_PROPERTY = "guiThemedIconName"
_ICON_SIZE_PROPERTY = "guiThemedIconSize"
