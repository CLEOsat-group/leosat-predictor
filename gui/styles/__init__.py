"""Application-level theme helpers for the production GUI client."""
...
def apply_dashboard_theme(application: Any, theme: str | None = None) -> str:
    """Apply one GUI theme and publish its identity on the application.
    ...
    from gui.styles.icon_provider import refresh_themed_icons
    from gui.styles.effects import refresh_card_elevation
